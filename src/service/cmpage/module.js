...
module.exports = class extends Base {
    ...
    editTypes(){
        return [{value:"text",text:"文本"},{value:"textarea",text:"多行文本"},{value:"number",text:"数字"},{value:"datetime",text:"日期时间"},
            {value:"checkbox",text:"是否选中"},{value:"select",text:"下拉单选"},{value:"selectMultiple",text:"下拉多选"},{value:"lookup",text:"查找带回"},
            {value:"hidden",text:"隐藏"},{value:"areaSelect",text:"地区联动"},{value:"codeSelect",text:"代码联动"},{value:"readonly",text:"只读"},
            {value:"kindeditor",text:"富文本"},{value:"selectTree",text:"下拉树单选"},{value:"selectTreeMultiple",text:"下拉树多选"},{value:"fileUpload",text:"文件上传"}];
    }
    //查询项的控件类型
    queryTypes(){
        return [{value:"text",text:"文本"},{value:"number",text:"数字"},{value:"datetime",text:"时间"},{value:"checkbox",text:"是否选中"},{value:"select",text:"下拉单选"},{value:"selectMultiple",text:"下拉多选"},
            ...
            {value:"areaSelect",text:"地区联动"},{value:"codeSelect",text:"代码联动"}];
    }
    ...
    async resetModuleCol(moduleID){
        ...
        let md = await this.model('t_module','cmpage').where({id:moduleID}).find();
...
//        if(think.isEmpty(rec))  return;
    ...
    async getModuleByName(modulename){
        return await think.cache(`modulename${modulename}`, () => {
            return this.model('t_module','cmpage').where({c_modulename:modulename,c_status:0}).find();  //query(`select * from t_module where c_modulename = '${modulename}' and c_status=0`);
        });
    }
