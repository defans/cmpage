...
exports.enumDocuType = {
    OrderApply: 1,
    OrderApply_name: '采购申请单',
    OrderApply_header: 'PR',
    Order: 2,
    Order_name: '采购订单',
    Order_header: 'PO',
    DocuArrive: 3,
    DocuArrive_name: '到货通知单',
    DocuArrive_header: 'DD',
    DocuCheck: 4,
    DocuCheck_name: '外购入库单',
    DocuCheck_header: 'GR',
    DocuSale: 5,
    DocuSale_name: '销售出库单',
    DocuSale_header: 'XC',
    ...
    DocuStock_header: 'PD',
    DocuTransfer: 8,
    DocuTransfer_name: '调拨单',
    DocuTransfer_header: 'DB',
    DocuBill: 20,
    DocuBill_name: '采购单发票',
    DocuBill_header: 'FP'
};
...
exports.enumActType = {
    NORMAL_MAN: 1,
    NORMAL_MAN_name: '人为参与',
    NORMAL_AUTO: 2,
    NORMAL_AUTO_name: '自动执行',
    START: 3,
    START_name: '开始节点',
    DUMMY: 4,
    DUMMY_name: '哑活动',
...
exports.enumActCcRule = {
    ...
    AUTO_name: '自动发送',
    MAN_AND_AUTO: 4,
    MAN_AND_AUTO_name: '手动和自动',
    DEFINE: 9,
    DEFINE_name: '自定义'
};
exports.enumActAssignType = {
    DEPT: 2,
    DEPT_name: '部门', //可以考虑加入岗位等类型
    ROLE: 3,
    ROLE_name: '角色',
    TEAM: 4,
    TEAM_name: '团队',
...
exports.enumActAssignWay = {
    ALL: 1,
    ALL_name: '所有人',
    LEAST_WORKING_LIST: 2,
    LEAST_WORKING_LIST_name: '最少工作量', //任务将分配给指定群体中的工作量最少的人员，工作量的多少可以通过TO_DO_TASK_LIST的统计数据得到
    FCFA: 3,
    FCFA_name: '先来先分配', //（First Coming First Assigning）
    PRIORITY: 4,
    PRIORITY_name: '优先数大者', //基于优先数分配（c_type==ROLE），每个角色中的人员都有一个优先数，数大者得
    ROUND_ROBIN: 5,
    ROUND_ROBIN_name: '令牌轮转', //轮转法（c_type==ROLE），ROUND_ROBIN_TOKEN为轮转令牌，任务将分配给携有轮转令牌的人员
    SELECT: 6,
    SELECT_name: '提供选择', //，上一个活动的执行人来选择
    MANAGER: 7,
    MANAGER_name: '主管'
};
exports.enumActAssignTypeExe = {
    ...
    EXE_name: '执行并无通知',
    EXE_AND_BEFORE_CC: 2,
    EXE_AND_BEFORE_CC_name: '执行并事前通知',
    AFTER_CC: 3,
